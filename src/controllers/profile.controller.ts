...
class ProfileController {
	...
	public updatePreferences = catchAsync(
		async (req: UpdatePreferencesRequest, res: Response) => {
			const response = await preferencesService.updatePreferences(req.user.id, req.body);
			return handleServiceResponse(response, res);
		},
	);
}
