...
export const firstNameFrom = (name: string) => name.split(" ")[0] || name;

export const verificationEmailHtml = (firstName: string, verifyUrl: string) => `
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <a href="${verifyUrl}" style="background-color: #4CAF50; color: white; padding: 14px 24px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block;">
        Verify email
      </a>
    </div>
    <p style="font-size: 12px; color: #666;">If the button doesn't work, paste this link into your browser:<br/>${verifyUrl}</p>
    <p>If you didn't create an account with us, you can ignore this email.</p>
    <p>Best regards,<br>${ORGANIZATION_NAME}</p>
  </div>
`;

export const passwordResetEmailHtml = (firstName: string, resetUrl: string) => `
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    <h2>Password Reset Request</h2>
    <p>Hi ${firstName},</p>
    <p>You requested to reset your password. Click the button below to choose a new one (link valid for 1 hour):</p>
    <div style="text-align: center; margin: 30px 0;">
      <a href="${resetUrl}" style="background-color: #4CAF50; color: white; padding: 14px 24px; text-decoration: none; border-radius: 4px; font-weight: bold; display: inline-block;">
        Reset password
      </a>
    </div>
...
export const welcomeEmailHtml = (firstName: string, url: string) => `
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
    <h2>Welcome, ${firstName}!</h2>
    <p>We're excited to have you on board. Click the button below to get started:</p>
    <div style="text-align: center; margin: 30px 0;">
      <a href="${url}" style="background-color: #4CAF50; color: white; padding: 14px 20px; text-decoration: none; border-radius: 4px;">
        Get Started
      </a>
    </div>
            ...
            <div class="social-icons">
              ...
              >
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path d="M7 2C4.24 2 2 4.24 2 7v10c0 2.76 2.24 5 5 5h10c2.76 0 5-2.24 5-5V7c0-2.76-2.24-5-5-5H7zm5 6a5 5 0 1 1 0 10 5 5 0 0 1 0-10zm6.5-3a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3z" />
                </svg>
              </a>
              <a
                class="social-link"
              ...
              >
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path d="M12.75 3h3.06c.18 1.56 1.37 3.2 3.19 3.6v3.15a6.27 6.27 0 0 1-3.19-.88v5.68c0 3.45-2.88 6.25-6.44 6.25S3.94 18 3.94 14.44 6.81 8.19 10.38 8.19v3.2a3.05 3.05 0 0 0-3.06 3.05 3.05 3.05 0 0 0 3.06 3.05c1.7 0 3.07-1.37 3.07-3.05V3z" />
                </svg>
              </a>
              <a
                class="social-link"
              ...
              >
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path d="M12 2.04C6.48 2.04 2 6.52 2 12.04c0 4.13 2.52 7.66 6.13 9.18-.09-.78-.17-1.98.04-2.83.18-.77 1.16-4.89 1.16-4.89s-.3-.61-.3-1.51c0-1.41.82-2.47 1.84-2.47.87 0 1.29.65 1.29 1.43 0 .87-.55 2.18-.83 3.39-.24 1.02.52 1.85 1.54 1.85 1.85 0 3.27-1.95 3.27-4.77 0-2.49-1.79-4.23-4.34-4.23-2.96 0-4.71 2.22-4.71 4.52 0 .9.35 1.87.8 2.4.09.11.1.21.08.33-.09.36-.29 1.13-.33 1.29-.05.21-.17.26-.4.16-1.49-.69-2.43-2.85-2.43-4.59 0-3.73 2.71-7.17 7.82-7.17 4.1 0 7.29 2.93 7.29 6.84 0 4.08-2.57 7.37-6.13 7.37-1.2 0-2.32-.63-2.71-1.36l-.74 2.83c-.27 1.04-1 2.34-1.49 3.13 1.12.35 2.3.54 3.53.54 5.52 0 10-4.48 10-10s-4.48-10-10-10z" />
                </svg>
              </a>
              <a
                class="social-link"
              ...
              >
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                  <path d="M18.9 2H22l-7.98 9.14L23 22h-7.1l-5.5-6.63L4.9 22H2l8.58-9.84L2.4 2h7.2l5 5.94L18.9 2zm-2.43 18h1.7L7.64 4h-1.8l10.63 16z" />
                </svg>
              </a>
            </div>
          </div>
