...
export const updateFontSchema = z.object({
	body: z.object({
		...
		fillColor: z.string().optional(), // .regex(/^#[a-zA-Z0-9]{3,8}$/),
		strokeColor: z
			.string()
			// .regex(/^#[a-zA-Z0-9]{3,8}$/)
			.optional(),
...
export const updateCornersSchema = z.object({
	body: z.object({
		...
		fillColor: z.string().optional(), // .regex(/^#[a-zA-Z0-9]{3,8}$/).optional(),
		strokeColor: z.string().optional(), // .regex(/^#[a-zA-Z0-9]{3,8}$/).optional(),
		opacity: z.number().min(0).max(1).optional(),
		shadowSize: z.string().optional(),
		shadowColor: z.string().optional(), //.regex(/^#[a-zA-Z0-9]{3,8}$/),
	}),
});
